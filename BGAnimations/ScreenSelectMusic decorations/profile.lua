...
--Sets locals for profile display (thanks prov) -ryan
t[#t + 1] =
	Def.Actor {
	BeginCommand = function(self)
		self:queuecommand("Set")
...
t[#t + 1] =
	...
	InitCommand = function(self)
		self:xy(frameX - 18, frameY - 18):zoomto(frameWidth, frameHeight + 55):halign(0):valign(0)
	end
}
t[#t + 1] =
	Def.Sprite {
	Texture="_msd bgmask",
	InitCommand = function(self)
		self:xy(frameX - 18, frameY - 18):zoomto(frameWidth, frameHeight + 55):halign(0):valign(0):diffusealpha(0.8)
	end
}
...
local function rankingButton(i)
	local t =
		Def.ActorFrame {
		InitCommand = function(self)
			self:xy(rankingX + (i - 1) * rankingTitleSpacing - 20, rankingY):zoom(0.8)
		end,
		Def.Quad {
			InitCommand = function(self)
				self:zoomto(rankingTitleSpacing + 10.5, 30):diffuse(getMainColor("frames")):diffusealpha(0.35)
			end,
			SetCommand = function(self)
		...
		LoadFont("ZenithBold") ..
			{
				InitCommand = function(self)
					self:diffuse(getMainColor("positive")):maxwidth(60):maxheight(25):zoom(0.65)
				end,
				BeginCommand = function(self)
...
t[#t + 1] =
	...
	Def.ActorFrame {
		InitCommand = function(self)
			self:xy(rankingX + frameWidth / 4 - rankingTitleSpacing - 20, rankingY + offsetY * 0.9 + 30)
		end,
		Def.Quad {
			InitCommand = function(self)
	...
	Def.ActorFrame {
		InitCommand = function(self)
			self:xy(rankingX + frameWidth * 3 / 4 - rankingTitleSpacing - 30, rankingY + offsetY * 0.9 + 30)
		end,
		Def.Quad {
			InitCommand = function(self)
...
local profilebuttons =
	Def.ActorFrame {
	InitCommand = function(self)
		self:xy(frameX + 90, frameHeight + 60)
